...
//        NSLog(@"%@", instrumentDictionary);
        ...
        [APMusicalInstrument instrumentWithName:[instrumentDictionary objectForKey:@"name"]
                                    description:[instrumentDictionary objectForKey:@"description"]
                                           type:(MusicalInsrymentType)[(NSNumber *)[instrumentDictionary objectForKey:@"type"] integerValue]
                                       andImage:[instrumentDictionary objectForKey:@"image"]];
